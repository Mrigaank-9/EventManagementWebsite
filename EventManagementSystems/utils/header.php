    ...
    <div class = "col-md-12">
        <div class = "container">
            <div class = "jumbotron"><!--jumbotron-->
                <h1>Event Management Website </h1><!--jumbotron heading-->
                <p><!--jumbotron content-->
                Whether you're looking to book a venue for Hack a thon , public gathering, celebratory function, conference, business
                meeting, wedding or Concerts , our dedicated  Events Management team can create a package that will meet
                your every need.
                </p>
                <p id="dateAndTime"></p>
            </div>
